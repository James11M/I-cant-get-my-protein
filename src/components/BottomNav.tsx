...
const styles = StyleSheet.create({
  ...
  add: { flex: 1, alignItems: 'center', minHeight: 68, marginTop: -18 },
  addCircle: { width: 52, height: 52, borderRadius: 26, alignItems: 'center', justifyContent: 'center', backgroundColor: colours.gold },
  addPlus: { color: colours.background, fontSize: 35, fontWeight: '500', lineHeight: 37 },
  addLabel: { color: colours.gold, fontSize: 8, fontWeight: '900', marginTop: 3, letterSpacing: 0.9 },
